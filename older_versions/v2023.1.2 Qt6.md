...
Install [PyQt6](https://pypi.org/project/PyQt6/) version 6.5.0
...
wget https://github.com/psychopy/psychopy/archive/refs/tags/2023.1.2.zip
unzip 2023.1.2.zip
...
| have shaders                          | True                                      |           |
| visual sync (refresh)                 | 8.27 ms                                   | 1         |
| refresh stability (SD)                | 4.79 ms                                   | 1         |
| no dropped frames                     | 2 / 181                                   | 1         |
