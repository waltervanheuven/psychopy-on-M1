# PsychoPy v2022.1.4 on Apple Silicon Macs (using Qt6)

The current version of [PsychoPy](https://www.psychopy.org) runs on Apple Silicon (M1) Macs through Rosetta 2. Below are instructions to install a native Apple Silicon (arm64) version of PsychoPy using Qt6 on Macs running macOS Monterey (version 12.4).
...
Install [PyQt6](https://pypi.org/project/PyQt6/) version 6.3.0
...
[psychtoolbox](http://psychtoolbox.org) version: 3.0.18.10
...
Note that latest version (8.5) results in ioHub errors.
...
[PsychoPy source v2022.1.4](https://github.com/psychopy/psychopy).
...
I've tested a few experiments and most things seem to work.
...
Benchmark wizard report (M1 MacBook Pro, macOS 12.4). Screen size is incorrect (should be 2560 x 1600) and `pyo` is reported missing.
