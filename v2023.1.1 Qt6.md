...
Install [PyQt6](https://pypi.org/project/PyQt6/) version 6.4.3
...
pygame uses [SDL](https://libsdl.org) 2.24.2
...
wget https://github.com/psychopy/psychopy/archive/refs/tags/2023.1.1.zip
unzip 2023.1.1.zip
cd psychopy-2023.1.1
```
...
| have shaders                          | True                                      |           |
| visual sync (refresh)                 | 8.53 ms                                   | 1         |
| refresh stability (SD)                | 4.73 ms                                   | 1         |
