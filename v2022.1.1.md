...
Adding `psychopy` (~/venv/psychopy/bin/psychopy) to `Full Disk Access` in `Security & Privacy` (System Preferences) helps? Also, turning `Secure Keyboard Entry` off in iTerm seems to help!?
