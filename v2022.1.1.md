...
Install PyQt5 using [brew](https://brew.sh). Requires `venv` with `system-site-packages` to work in Python. It is possible to use Qt6 and install that using pip, see instructions in this file [v2022.1.1 Qt6](v2022.1.1%20Qt6.md)
...
After making the above changes in `clock.py` or by copying the `clock.py` file from this repository to the `psychopy-release` folder, install psychopy from source.
