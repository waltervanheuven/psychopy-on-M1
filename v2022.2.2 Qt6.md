...
# if you are using python@3.10 (installed with brew), switch back to 3.9 with these commands
brew unlink python@3.10
brew link --force python@3.9
```
Python 3.9.13 (24 May 2022).
...
Benchmark wizard report (M1 Max MacBook Pro 14", macOS 12.4, native screen set to 60 Hz - no ProMotion). 
...
| have shaders                          | True                                      |
| visual sync (refresh)                 | 16.62 ms                                  |
| refresh stability (SD)                | 3.13 ms                                   |
