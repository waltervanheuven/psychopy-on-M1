...
- [clock.py](modified-files/psychopy-release/psychopy/clock.py) with fix for getTime(), further info can be found in the instructions for installation of PsychoPy with Qt5 [v2022.1.1](v2022.1.1.md)
