# PsychoPy v2022.1.1 on Apple Silicon Macs (using Qt6)
...
Install PyQt6 version 6.2.3

Note that PyQt5 fails to install using pip. However, PyQt6 can be installed with pip but it requires building PsychoPy from source and a change in `setup.cfg`. Please note that it is possible to install PyQt5 using [brew](https://brew.sh) (see Installation PsychoPy version [v2022.1.1](v2022.1.1.md)). 
...
Replace the following files in the `psychopy-release` folder with the ones available in this repository.
...
| have shaders                          | True                                      |
| visual sync (refresh)                 | 16.73 ms                                  |
| refresh stability (SD)                | 0.79 ms                                   |
