...
There is an issue with one of the header files. To fix this replace the file `pyo/include/ad_coreaudio.h` with [this file](modified-files/pyo/include/ad_coreaudio.h).
...
- [clock.py](modified-files/psychopy-release/psychopy/clock.py) with fix for getTime(), further info about this issue can be found in the instructions for installation of PsychoPy with Qt5 [v2022.1.1](v2022.1.1.md)
- [setup.cfg](modified-files/psychopy-release/setup.cfg) with PyQt6 requirement
...
- Benchmark wizard: dots not moving.
