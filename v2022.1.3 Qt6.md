...
The current version of [PsychoPy](https://www.psychopy.org) runs on Apple Silicon (M1) Macs through Rosetta 2. Below are instructions to install a native Apple Silicon (arm64) version of PsychoPy using Qt6 on Macs running macOS Monterey (version 12.3.1).
...
[psychtoolbox](http://psychtoolbox.org) version: 3.0.18.7 (SP2)
