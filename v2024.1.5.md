...
mkdir tmp
cd tmp
wget https://github.com/psychopy/psychopy/archive/refs/tags/2024.1.5.zip
unzip 2024.1.5.zip
...
#   - upgraded pyglet to latest 1.5.29
...
cd ..
cp pyproject.toml tmp/psychopy-2024.1.5/

cd tmp/psychopy-2024.1.5
...
Benchmark wizard result screen in version 2024.1.5 is not visible (black screen).
