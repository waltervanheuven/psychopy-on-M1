...
### pygame with latest SDL (does not fix vsync issue on Ventura)

Alternatively: Install pygame with latest [SDL2](https://libsdl.org).
...
## 8. Install Psychtoolbox from source
