...
To fix this error, clone repository [https://github.com/cryptlex/lexactivator-c](https://github.com/cryptlex/lexactivator-c)

```sh
cd tmp
git clone -b 3.0.20.1 https://github.com/Psychtoolbox-3/Psychtoolbox-3.git
git clone https://github.com/cryptlex/lexactivator-c.git

# copy missng files to Psychtoolbox-3
...
#   - change wxPython to version 4.2.1 because with version 4.2.2 PsychoPy doesn't work
